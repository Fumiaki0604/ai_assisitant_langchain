...
- knowledge  : 知識・仕様・方法を問う質問（社内特有の情報）。例「GA4のイベント設定は？」
- experience : 社内で「過去に担当・経験・実装した人」を探す質問（人探し）。
  シグナル：「実装したことある方」「事例ある？」「〜を集めてます」「〜担当したことある方」「過去に〜やった方」
- document   : 社内資料・テンプレートを持つ人を探す質問。例「〜資料お持ちの方」
- owner      : 特定案件・顧客・業務の担当者を探す質問。例「PDC担当の方いますか？」
- opinion    : アイデア・施策・アドバイス・意見を求める質問（一般知識でも答えられる）。
  シグナル：「効果的な施策ご存知の方いれば案ほしい」「アドバイスほしい」「良い方法ある？」
  「どんなアプローチが効果的？」「何かいい案ある？」「これどう思う？」「ブレストしたい」
  ※「知ってる方いれば」でもアイデア・施策を求めている場合は opinion
...
⑤次の行動の妥当性（20点）
- experience/owner/document: 余計な提案なしで満点。社内の次の一手を示せばなお良い
- opinion: アイデア・施策を1つ以上出していれば満点。「確認できませんでした」で終わったら 0点
- knowledge: 次のアクションや参照先を示せば満点
