...
- experience: 社内の実績・事例・案件経験・実装知見を探す質問。
  例「Shopify導入事例ある？」「採用サイト担当したことある方？」「〜の事例を集めてます」
  「〜変数がわかりません、どなたかご存知ですか」「〜実装したことある方いますか」「〜知ってる人いますか」
...
判定のヒント：「どなたかご存知ですか」「知ってる方いますか」は experience または owner のシグナル。
一般的な仕様・概念の説明を求めていない場合は knowledge にしない。
