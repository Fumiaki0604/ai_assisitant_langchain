...
RUN pip install --no-cache-dir -r requirements.txt && \
    ...
    python -c "from langchain_community.embeddings import HuggingFaceEmbeddings; HuggingFaceEmbeddings(model_name='cl-nagoya/ruri-v3-310m', model_kwargs={'device': 'cpu'}); print('Ruri embedding model downloaded')"
